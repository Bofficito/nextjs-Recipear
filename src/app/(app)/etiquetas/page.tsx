      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center justify-center py-20 gap-4 text-center">
          ...
          <p className="text-sm text-stone-400 max-w-sm">
            Las etiquetas personalizadas están disponibles a partir del plan
            Pro.
          </p>
          <Link
            href="/planes"
    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="text-sm text-stone-400 mt-1">
          Organizá tus recetas con etiquetas personalizadas.
        </p>
        <div className="bg-stone-50 border border-stone-200 rounded-xl px-4 py-3 mt-3">
          <p className="text-sm text-stone-600 leading-relaxed">
            ...
            por ejemplo <span className="font-medium">sin gluten</span>,{" "}
            <span className="font-medium">para invitados</span> o{" "}
            <span className="font-medium">favoritas de los chicos</span>. Una
            vez creadas, podés asignarlas al crear o editar una receta y filtrar
            por ellas desde el recetario.
          </p>
        </div>
      </div>
